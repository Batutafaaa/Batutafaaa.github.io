...
| States covered | 36 |
| Distinct crops | 142 |
| General Caste observations | 45,149 |
| OBC observations | 16,059 |
| SC observations | 4,412 |
| ST observations | 8,945 |
...
|---|---|---|---|
| M1: Crop FE only | −2.4% | −0.9% | +1.4% |
| M2: + Wealth & Land | −1.8% | −2.3% | +1.7% |
| M3: + District FE | −2.0% | −2.1% | +1.7% |
| M4: + State FE | −0.6% | **−4.6%\*\*** | +0.7% |
| M5: District FE, no qty | −1.4% | +0.4% | +2.0%\* |
